                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ route('siswa.aspirasi.destroy', $aspirasi->id_aspirasi) }}" class="delete-form" onsubmit="return confirm('Apakah Anda yakin ingin menghapus pengaduan ini?')">
                                        @csrf
                                        @method('DELETE')
...
<script>
// Konfirmasi hapus dengan SweetAlert (opsional - jika ingin lebih bagus)
